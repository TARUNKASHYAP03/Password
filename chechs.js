...
function generateLowercase() {
    return String.fromCharCode(getRndInteger(97, 123));//Ascvalue to char
}

function generateUppercase() {
    return String.fromCharCode(getRndInteger(65, 91));//Ascvalue to char
}
...
generateBtn.addEventListener('click', () => {
    ...
    // let's start the jouney to new password
